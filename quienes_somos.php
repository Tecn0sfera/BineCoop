    ...
    <section class="origins scroll-reveal">
        <div class="origins-container">
            <div class="origins-content">
                <h2>¿Quiénes somos?</h2>
                <p>Somos BINECOOP (Bienestar de Cooperativa Pública Nacional), una cooperativa de vivienda fundada en 1938 por trabajadores organizados —sindicalistas, obreros portuarios y empleados del Estado— con el objetivo de garantizar el acceso a una vivienda digna como un derecho colectivo.
